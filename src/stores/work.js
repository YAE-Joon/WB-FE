...
export const useWorkStore = defineStore('work', {
  ...
  actions: {
    async fetchWorks() {
      ...
      this.error = null
      try {
        const response = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/works`)
    ...
    async createWork(workData) {
      ...
      this.error = null
      try {
        const response = await axios.post(`${import.meta.env.VITE_API_BASE_URL}/works`, workData)
    ...
    async updateWork(workId, workData) {
      ...
      this.error = null
      try {
        const response = await axios.put(`${import.meta.env.VITE_API_BASE_URL}/works/${workId}`, workData)
    ...
    async deleteWork(workId) {
      ...
      this.error = null
      try {
        await axios.delete(`${import.meta.env.VITE_API_BASE_URL}/works/${workId}`)
    ...
    async updateWorkState(workId, stateId) {
      try {
        const response = await axios.post(`${import.meta.env.VITE_API_BASE_URL}/works/${workId}/state`, {
          state_id: stateId
        })
